...
import PeersimSimulator.peersim.*;
 ...
 * {@link PeersimSimulator.peersim.util.StringListParser}. </LI>
 * </UL>
 ...
 * (for PeersimSimulator.example due to path problems), the command shell mechanism
 * is used to run the first JVM version found in the path.
 * </p>
 * It is possible to specify options for the forked JVM using the
 * {@value #PAR_JVM} parameter on the command line. For PeersimSimulator.example,
 * a command line like this:
<pre>
java PeersimSimulator.peersim.rangesim.RangeSimulator config.file jvm.options=-Xmx256m
</pre>
...
private void doExperiments(String[] args)
{
	...
	list.add("PeersimSimulator.peersim.Simulator");
...
private static void usage()
{
	...
	System.err.println("  PeersimSimulator.peersim.RangeSimulator <configfile> [property]*");
}
