 ...
 * <code>{@value PeersimSimulator.peersim.config.Configuration#PAR_INCLUDE}+"."+name</code> or
 * <code>{@value PeersimSimulator.peersim.config.Configuration#PAR_ORDER}+"."+name</code> then the order is
