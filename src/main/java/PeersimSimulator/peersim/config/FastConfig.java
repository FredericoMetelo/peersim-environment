...
/**
 * This array stores the protocol ids of the {@link PeersimSimulator.peersim.core.Linkable}
 * protocols that are linked to the protocol given by the array index.
 */
protected static final int[][] links;

/**
 * This array stores the protocol id of the {@link PeersimSimulator.peersim.transport.Transport}
