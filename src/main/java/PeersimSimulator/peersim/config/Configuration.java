 ...
 * are strings of alphanumeric and underscore characters. For PeersimSimulator.example,
 ...
 * the type, and the second is the name of a component. For PeersimSimulator.example,
 * 
 * <pre>
 ...
 * name begins with <code>include</code>. For PeersimSimulator.example
 * 
 * <pre>
 ...
 * <code>control.2</code>, in this order. Note that for PeersimSimulator.example the
 ...
 * integer. So, for PeersimSimulator.example, 5/2 returns 2. If one of the sub-expression is
 ...
 * PeersimSimulator.example, 5.0/2 returns 2.5.
 * 
 * <p>
