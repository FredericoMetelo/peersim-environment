...
package PeersimSimulator.peersim.edsim;
...
* can bridge the gap between {@link PeersimSimulator.peersim.cdsim} and the event driven
* engine. It can wrap {@link PeersimSimulator.peersim.cdsim.CDProtocol} appropriately so that the
...
* and more realism to {@link PeersimSimulator.peersim.cdsim.CDProtocol} simulations,
* at the cost of some
* loss in performance.
* <p>
...
* This functionality is implemented in package {@link PeersimSimulator.peersim.transport}.
* @see Configuration
 */
