...
import PeersimSimulator.peersim.dynamics.NodeInitializer;
...
* (see config parameter {@value PeersimSimulator.peersim.core.Scheduler#PAR_STEP} of
 ...
 * value of parameter {@value PeersimSimulator.peersim.core.Scheduler#PAR_FROM} of the
 * protocol being
 ...
 * not to use parameter {@value PeersimSimulator.peersim.core.Scheduler#PAR_FROM}
 * in protocols, but
